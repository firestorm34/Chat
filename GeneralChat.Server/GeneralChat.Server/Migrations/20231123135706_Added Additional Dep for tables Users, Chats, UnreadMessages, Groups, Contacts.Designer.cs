...
namespace GeneralChat.Server.Migrations
{
    ...
    [Migration("20231123135706_Added Additional Dep for tables Users, Chats, UnreadMessages, Groups, Contacts")]
    partial class AddedAdditionalDepfortablesUsersChatsUnreadMessagesGroupsContacts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeneralChat.Server.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("GeneralChat.Server.Models.Role", null)
                        .WithMany()
